...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Lock(LockModeType.PESSIMISTIC_WRITE) // Agar data tidak bisa diubah oleh proses lain sampai method yang memanggil ini selesai (method harus @Transactional)
    @Query(value = """
    ...
    @Query(value = """
            SELECT * FROM product
            """, nativeQuery = true)
    Stream<Product> streamAll(); // Lebih baik menggunakan Stream daripada List untuk select data besar
}
