...
public class ProductIndexServiceImpl implements ProductIndexService {
    ...
    public void reindexProduct(Product product) {
        ...
        try {
            ...
            log.error("Error while reindex product with id " + product.getProductId() + " error: " + ex.getMessage());
        } catch (Exception e) {
    ...
    public void deleteProduct(Product product) {
        ...
        try {
            ...
            log.error("Error while deleting product with id " + product.getProductId() + " error: " + ex.getMessage());
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public void reindexProductActivity(Long productId, ActivityType activityType, Long value) {
        ...
        try {
            ...
            log.error("Error while updating product with id " + productId + " error: " + ex.getMessage());
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
